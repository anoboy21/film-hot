  ...
  return (
    <Fragment>
      ...
      >
        ...
        <div className="mt-0 sm:mt-4 xl:mt-0 block sm:flex flex-col gap-0 sm:gap-4 xl:block xl:gap-0">
          ...
          <div className="flex flex-col items-stretch gap-3">
            ...
            >
              <i className="fa-solid fa-house-chimney text-xl w-[24px]"></i>
          ...
          {!currentUser ? (
            ...
            <div className="flex flex-col gap-3 items-stretch">
              ...
              <button
                ...
                className="flex items-center gap-2 cursor-pointer transition text-gray-400 hover:text-gray-300"
              >
      ...
      <div
        ...
        className={`bg-[#00000080] z-[5] fixed top-0 left-0 w-full h-full transition-all duration-500 ${
